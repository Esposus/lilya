...
Создание Lilya вдохновлено работами тех, кто стоял у истоков. Она представляет собой более простой, точный,
быстрый и удобный в использовании набор инструментов/фреймворк на Python, нацеленный на простоту.

Часто нет необходимости в полноценном веб-фреймворке на Python, так как это может быть излишне
для решения простых задач. Вместо этого предпочтительнее использовать простой ASGI-инструментарий,
который поможет в создании готовых к производству, быстрых, элегантных, поддерживаемых и модульных приложений.

Именно здесь Lilya находит своё применение.

Почти нет жестких зависимостей, 100% написаный на Python, полностью типизированный и готовый к использованию в продакшене.
